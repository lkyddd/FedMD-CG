...
def get_args():
    ...
    parser.add_argument('--gen_batch_size', type=int, default=64)  # 128 
    ...
    parser.add_argument("--I_lm", type=int, default=20)
    ...
    parser.add_argument("--I_gen", type=int, default=20)
    ...
    parser.add_argument("--diversity_loss_type", type=str, default='div0', choices=['div0', 'div1', 'div2'], help="diversity loss")
